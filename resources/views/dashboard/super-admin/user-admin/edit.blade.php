...
<script>
  ...
  // if role is superadmin or superadmin2 disable fakultas and program studi and reset it
  $('#role').on('change', function() {
    if ($(this).val() == 'superadmin' || $(this).val() == 'superadmin2' || $(this).val() == 'surveyor') {
