        ...
        <div class="main-body">
                        ...
                        <div class="card-body bg-light rounded p-5 border-top border-success border-5">
                            <div class="d-flex flex-column align-items-center text-center">
                                <div class="rounded-circle overflow-hidden" style="width: 150px; height: 150px;">
                                    <img src="{{ $user->foto ? url('https://pmb.uinsu.ac.id/file/photo/' . $user->foto) : url('/img/account.png') }}"
                            ...
                            <div class="row ">
                                <div class="col">
                                    ...
                                    <span class="text-secondary my-1"><a style="text-decoration: none" class="text-success"
                                            href="{{ $user->linkedin ? $user->linkedin : 'Belum diisi' }}">Kunjungi</a></span>
                                    <hr>
                                </div>
                            </div>
                            <div class="row ">
                                <div class="col">
                                    ...
                                    <span class="text-secondary my-1"><a style="text-decoration: none" class="text-success"
                                            href="{{ $user->facebook ? $user->facebook : 'Belum diisi' }}">Kunjungi</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <hr> --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <ul>
                                        <li class="mb-1">Provinsi :
                                            {{ $user->provinsi ? $user->provinsi : 'Belum diisi' }}</li>
                                        <li class="my-1">Kabupaten/Kota :
                                            {{ $user->kabupaten ? $user->kabupaten : 'Belum diisi' }}</li>
                                        <li class="my-1">Kecamatan :
                                            {{ $user->kecamatan ? $user->kecamatan : 'Belum diisi' }}</li>
                                        <li class="my-1">Alamat : {{ $user->alamat ? $user->alamat : 'Belum diisi' }}
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-12 text-end">
                                    <a href="/dashboard/admin/super/user/{{ $user->id }}/edit"
                                        class="btn btn-warning text-white"><i class="bi bi-pencil-square"></i> Perbaharui
                                        Data Diri</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="accordion " id="accordionExample">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button border-top border-success border-5 bg-light shadow rounded"
                                    type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                                    aria-expanded="true" aria-controls="collapseOne" style="background-color: #fff;">
                      ...
                      <a href="/dashboard/perjalanan-karir/create" class="btn btn-success btn-sm @if ($user->is_bekerja == 0) disabled @endif"><i class="bi bi-plus-lg"></i> Tambah Riwayat</a>
                          ...
                          Bekerja
                                                    ...
                                                    <div class="timeline__event__description">
                                                        <small class="text-muted">Hapus untuk menambah riwayat
                                                            lainnya</small>
                                                    </div>
                                                    <div class="col mt-2 float-end">
                                                        <form class="d-inline" action="/dashboard/hapusBelumKerja"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="btn btn-link btn-sm text-success m-0 p-0"><i
                                        ...
                                        @foreach ($pekerjaans as $pekerjaan)
                                            <div class="timeline__event animated fadeInUp delay-1s timeline__event--type1">
                                                ...
                                                <div class="timeline__event__content">
                                                    ...
                                                    {{-- @dd($pekerjaan) --}}
                                                    <div class="timeline__event__description">
                                                        <p>{{ \Carbon\Carbon::parse($pekerjaan->tanggal_mulai)->translatedFormat('d F Y') . ' - ' . ($pekerjaan->is_active ? 'Sekarang' : \Carbon\Carbon::parse($pekerjaan->tanggal_akhir)->translatedFormat('d F Y')) }}
                                                        </p>
                                                    </div>
                                                    <div class="col mt-2 float-end">
                                                        <a href="/dashboard/{{ $pekerjaan->tipe_kerja }}/{{ $pekerjaan->id }}/edit"
                                                            class="btn btn-link btn-sm text-success m-0 p-0"><i
                                                                class="bi bi-pencil-square"></i></a>
                                                        <form class="d-inline"
                                                            action="/dashboard/{{ $pekerjaan->tipe_kerja }}/{{ $pekerjaan->id }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="btn btn-link btn-sm text-success m-0 p-0"><i
                ...
                <div class="col-lg-6 col-md-6 col-sm-12  my-2  position-relative">
                    <div class="accordion" id="accordionEducation">
                        <div class="accordion-item">
                            ...
                            <div id="collapseEducation" class="accordion-collapse collapse show"
                                aria-labelledby="headingEducation" data-bs-parent="#accordionEducation">
                                <div class="accordion-body">
                                        ...
                                        @foreach ($user->pendidikan as $pendidikan)
                                            <div class="timeline__event animated fadeInUp delay-1s timeline__event--type1">
                                                ...
                                                <div class="timeline__event__content">
                                                    ...
                                                    <div class="timeline__event__description">
                                                        <p>{{ \Carbon\Carbon::parse($pendidikan->tgl_mulai_pendidikan)->translatedFormat('d F Y', 'id_ID') }}
                                                        </p>
                                                    </div>

                                                    <div class="col mt-2 float-end">
                                                        <a href="/dashboard/pendidikan/{{ $pendidikan->id }}"
                                                            class="btn btn-link btn-sm text-success m-0 p-0"><i
                                                                class="bi bi-eye"></i></a>
                                                        <a href="/dashboard/pendidikan/{{ $pendidikan->id }}/edit"
                                                            class="btn btn-link btn-sm text-success m-0 p-0"><i
                                                                class="bi bi-pencil-square"></i></a>
                                                        <form action="/dashboard/pendidikan/{{ $pendidikan->id }}"
                                                            method="post" class="d-inline m-0 p-0">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button class="btn btn-link btn-sm text-success m-0 p-0"
                            ...
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                <thead>
                                    <tr class="text-dark">
                                        ...
                                        <th style="background-color: transparent !important;" class="col">Perusahaan
                                        </th>
                                        <th style="background-color: transparent !important;" class="col">Posisi</th>
                                        <th style="background-color: transparent !important;" class="col text-center">Aksi
                                        </th>
                                    </tr>
                                </thead>
                                <tbody style="background-color: transparent !important;">
                                    @foreach ($user->career as $career)
                                        <tr>
                                            <td style="background-color: transparent !important;">{{ $loop->index + 1 }}
                                            </td>
                                            <td style="background-color: transparent !important;">
                                                {{ $career->company_name }}</td>
                                            <td style="background-color: transparent !important;">{{ $career->position }}
                                            </td>
                                            <td style="background-color: transparent !important;" class="text-center">
                                                <a href="/dashboard/admin/super/career/{{ $career->slug }}/judge"
                                                ...
                                                <a href="/dashboard/admin/super/career/{{ $career->slug }}/edit"
                                                    class="btn btn-success btn-sm px-1 m-1 py-0 text-white"><i
                                                        class="bi bi-pencil-square"></i></a>
                                                <form class="d-inline"
                                                    action="/dashboard/admin/super/career/{{ $career->slug }}"
                                                    method="post">
                                                    @csrf
                                                    @method('DELETE')
