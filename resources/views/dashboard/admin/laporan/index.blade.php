          ...
          <div class="bg-light rounded p-5 border-top border-success border-5" style="min-height: 80vh;">
              ...
              <div class="row g-0">
                <div class="col-lg-3 col-md-4 col-sm-10">
                    <a href="/dashboard/admin/laporan/create" class="btn btn-success btn-sm mb-3"><i
                      ...
                      <tbody style="background-color: transparent !important;">
                          @foreach ($laporans as $laporan)
                              <tr>
                                  ...
                                  <td style="background-color: transparent !important;" >                                      
                                      <a href="/dashboard/admin/laporan/{{ $laporan->id }}/edit"
                                          class="btn btn-success btn-sm px-1 m-1 py-0 text-white"><i
                                              class="bi bi-pencil-square"></i></a>        
                                      <form class="d-inline" action="/dashboard/admin/laporan/{{ $laporan->id }}"
                                          method="post">
                                          @csrf
                                          @method('DELETE')
