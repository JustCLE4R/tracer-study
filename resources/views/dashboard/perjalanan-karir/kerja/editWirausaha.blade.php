                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row g-4">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <label for="kriteria-pekerjaan" class="form-label text-secondary">Kriteria Pekerjaan
                                    *</label>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <label for="bidang-pekerjaan" class="form-label text-secondary">Bidang Pekerjaan *</label>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <label for="tingkat-ukuran-tempat-bekerja" class="form-label text-secondary">Tingkat /
                                    Ukuran Tempat Bekerja *</label>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <label for="posisi-jabatan-pekerjaan" class="form-label text-secondary">Posisi / Jabatan
                                    Pekerjaan *</label>
                                <select class="form-select" aria-label="Default select example"
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <label for="detail-pekerjaan" class="form-label text-secondary">Detail Pekerjaan *</label>
                                <input type="text" id="detail-pekerjaan" name="detail-pekerjaan" class="form-control">
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <label for="jumlah-pendapatan-perbulan" class="form-label text-secondary">Jumlah Pendapatan
                                    Perbulan *</label>
                                <input type="number" id="jumlah-pendapatan-perbulan" name="jumlah-pendapatan-perbulan"
                                    class="form-control">
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <label for="kesesuaian-pekerjaan-dengan-prodi" class="form-label text-secondary">Kesesuaian
                                    Pekerjaan dengan Prodi *</label>
                                <select class="form-select" aria-label="Default select example"
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <label for="tanggal-mulai-bekerja" class="form-label text-secondary">Tanggal Mulai Bekerja
                                    *</label>
                                <input type="date" id="tanggal-mulai-bekerja" name="tanggal-mulai-bekerja"
                                    class="form-control">
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <label for="tanggal-akhir-kerja" class="form-label text-secondary">Tanggal Akhir Kerja
                                    *</label>
                                <input type="date" id="tanggal-akhir-kerja" name="tanggal-akhir-kerja"
                                    class="form-control">
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                                <label for="formGroupExampleInput" class="form-label text-secondary">Provinsi *</label>
                                <input type="text" id="formGroupExampleInput" name="provinsi" class="form-control">
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                                <label for="formGroupExampleInput" class="form-label text-secondary">Kabupaten *</label>
                                <input type="text" id="formGroupExampleInput" name="kabupaten" class="form-control">
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                                <label for="formGroupExampleFile" class="form-label text-secondary">Foto/Bukti Telah
                                    Bekerja *</label>
                            ...
                            <div class="row justify-content-between mt-4" id="informasiPerusahaan">
                                <span class="h4">Informasi Perusahaan</span>
                                <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                                    <label for="formGroupExampleInput" class="form-label text-secondary">Nama Perusahaan
                                        *</label>
                                    <input type="text" id="formGroupExampleInput" name="nama-perusahaan"
                                        class="form-control">
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                                    <label for="formGroupExampleInput" class="form-label text-secondary">Nama Atasan
                                        *</label>
                                    <input type="text" id="formGroupExampleInput" name="nama-atasan"
                                        class="form-control">
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                                    <label for="formGroupExampleInput" class="form-label text-secondary">Posisi / Jabatan
                                        Atasan *</label>
                                    <input type="text" id="formGroupExampleInput" name="posisi-jabatan-atasan"
                                        class="form-control">
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                                    <label for="formGroupExampleInput" class="form-label text-secondary">Nomor Telepon
                                        Atasan *</label>
                                    <input type="text" id="formGroupExampleInput" name="nomor-telepon-atasan"
                                        class="form-control">
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12 my-2">
                                    <label for="formGroupExampleInput" class="form-label text-secondary">Alamat Email
                                        Aktif Atasan *</label>
