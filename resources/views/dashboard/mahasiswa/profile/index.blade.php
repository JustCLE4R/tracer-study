                        ...
                        <div class="card-body bg-light ">
                            <div class="d-flex flex-column align-items-center text-center">
                                <div class="rounded-circle overflow-hidden" style="width: 150px; height: 150px;">
                                    <img src="{{ Auth::user()->foto ? url('https://pmb.uinsu.ac.id/file/photo/' . Auth::user()->foto) : 'https://bootdey.com/img/Content/avatar/avatar7.png' }}"
                            ...
                            <div class="row ">
                                <div class="col">
                                    ...
                                    <span class="text-secondary my-1"><a style="text-decoration: none" class="text-success"
                                            href="{{ Auth::user()->linkedin ? Auth::user()->linkedin : 'Belum diisi' }}">Kunjungi</a></span>
                                    <hr>
                                </div>
                            </div>
                            <div class="row ">
                                <div class="col">
                                    ...
                                    <span class="text-secondary my-1"><a style="text-decoration: none" class="text-success"
                                            href="{{ Auth::user()->facebook ? Auth::user()->facebook : 'Belum diisi' }}">Kunjungi</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <ul>
                                        <li class="mb-1">Provinsi :
                                            {{ Auth::user()->provinsi ? Auth::user()->provinsi : 'Belum diisi' }}</li>
                                        <li class="my-1">Kabupaten/Kota :
                                            {{ Auth::user()->kabupaten ? Auth::user()->kabupaten : 'Belum diisi' }}</li>
                                        <li class="my-1">Kecamatan :
                                            {{ Auth::user()->kecamatan ? Auth::user()->kecamatan : 'Belum diisi' }}</li>
                                        <li class="my-1">Alamat :
                                            {{ Auth::user()->alamat ? Auth::user()->alamat : 'Belum diisi' }}</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-12 text-end">
                                    <a href="/dashboard/profile/edit" class="btn btn-success"><i
                                            class="bi bi-pencil-square"></i> Perbaharui Data Diri</a>
                                </div>
                            </div>
                        </div>
                    </div>
