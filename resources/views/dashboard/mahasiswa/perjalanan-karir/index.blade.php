                        ...
                        <div class="accordion-body">
                            <div class="timeline mx-3 pb-5">
                                <div class="row justify-content-between">
                                    <div class="col-7 ">
                                        <a href="/dashboard/perjalanan-karir/create"
                                            class="btn btn-success btn-sm @if (Auth::user()->is_bekerja == 0) disabled @endif"><i
                                                class="bi bi-plus-lg"></i> Tambah Riwayat</a>
                                    </div>
                                ...
                                @foreach ($pekerjaans as $pekerjaan)
                                    <div class="timeline__event animated fadeInUp delay-1s timeline__event--type1">
                                        ...
                                        <div class="timeline__event__content">
                                            ...
                                            {{-- @dd($pekerjaan) --}}
                                            <div class="timeline__event__description">
                                                <p>{{ \Carbon\Carbon::parse($pekerjaan->tanggal_mulai)->translatedFormat('d F Y') . ' - ' . ($pekerjaan->getRawOriginal('is_active') ? 'Sekarang' : \Carbon\Carbon::parse($pekerjaan->tanggal_akhir)->translatedFormat('d F Y')) }}
                                                </p>
                                            </div>
                                            <div class="col mt-2 float-end">
                                                @if ($pekerjaan->token)
                                                    <a href="{{ config('app.url') }}/questioner/{{ $pekerjaan->token }}"
                                                        class="copyLink btn btn-link btn-sm text-success m-0 p-0"><i
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header" id="headingEducation">
                        <button class="accordion-button border-top border-success border-5 bg-light shadow rounded"
                            ...
                            aria-expanded="true" aria-controls="collapseEducation" style="background-color: #fff;">
                        ...
                        <div class="accordion-body">
                            <div class="timeline pb-5">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-7 ">
                                        <a href="/dashboard/pendidikan/create" class="btn btn-success btn-sm"><i
                                                class="bi bi-plus-lg"></i> Tambah Riwayat</a>
                                    </div>
                                    <div class="col-5 text-end">
                                        <span class=" mt-1 text-success ">Setelah Lulus </span>
                                        ...
                                        <div class="timeline__event__content">
                                            ...
                                            <div class="col mt-2 float-end">
                                                ...
                                                <a href="/dashboard/pendidikan/{{ $pendidikan->id }}/edit"
                                                    class="btn btn-link btn-sm text-success m-0 p-0"><i
                                                        class="bi bi-pencil-square"></i></a>
                                                <form action="/dashboard/pendidikan/{{ $pendidikan->id }}" method="post"
