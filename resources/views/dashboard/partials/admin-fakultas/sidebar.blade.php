...
<div class="sidebar pe-4 pb-3 shadow ">
  <nav class="navbar">
    ...
    <div class="navbar-nav w-100 ">
      ...
      <a href="/dashboard/admin/fakultas/user" class="nav-item nav-link {{ Request::is('dashboard/admin/fakultas/user') ? 'active' : '' }}"><i class="bi bi-shield-lock me-2 fs-5"></i>Admin</a>
