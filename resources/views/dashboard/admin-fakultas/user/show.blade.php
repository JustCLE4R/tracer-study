          ...
          <div class="card-body bg-light rounded p-5 border-top border-success border-5">
            ...
            <div class="row mt-2">
              <div class="col-12 text-end">
                <a href="/dashboard/admin/fakultas/user/{{ $user->id }}/edit" class="btn btn-warning text-white"><i class="bi bi-pencil-square"></i> Perbaharui Data Diri</a>
              </div>
            </div>
          </div>
        </div>
                      ...
                      <tbody style="background-color: transparent !important;" >
                        ...
                        <tr>
                          ...
                          <td style="background-color: transparent !important;" class="text-center">
                            <a  href="/dashboard/admin/fakultas/career/{{ $career->slug }}/judge" class="btn btn-success btn-sm px-1 m-1 py-0 text-white"><i class="bi bi-eye"></i></a>
                            <a href="/dashboard/admin/fakultas/career/{{ $career->slug }}/edit" class="btn btn-success btn-sm px-1 m-1 py-0 text-white"><i class="bi bi-pencil-square"></i></a>
                            <form class="d-inline" action="/dashboard/admin/fakultas/career/{{ $career->slug }}" method="post">
                              @csrf
                              @method('DELETE')
