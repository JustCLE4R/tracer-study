  ...
  <div class="container my-4">
    <div class="row justify-content-center">
      <div class="col-md-8 text-center">
        ...
        <img class="img-fluid justify-self-center" src="{{ url('https://pmb.uinsu.ac.id/file/photo/' . $sertifikat->user->foto) }}" alt="" width="100">
        <div class="row">
          <div class="col-md-6">
    ...
    <div class="row justify-content-center mt-4">
      ...
      {{-- <div class="col-8 d-flex justify-content-center">
        <img class="img-fluid" src="{{ asset('storage/'.$sertifikat->qr_code) }}" alt="" width="150">
      </div> --}}
    </div>
  </div>
</body>
