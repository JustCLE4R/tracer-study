...
<body>
    ...
    <nav class="navbar shadow ps-2 pe-4 navbar-expand-lg bg-body-tertiary fixed-top ">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><img class="img-fluid" src="/img/logo.png" width="200px"
                    alt=""></a>
        ...
        <div class="container-fluid row header-text d-flex align-items-center justify-content-center">
            <div class="col-lg-7 col-md-10 col-sm-12 text-center">
                ...
                <button data-aos="fade-up" data-aos-duration="2000"
                    class="btn btn-lg btn-success rounded-pill py-1">Kunjungi Sekarang</button>
            </div>
        </div>
    </header>
    ...
    <article class="position-relative">
        <div class="row p-2 pb-5 justify-content-center ">
            ...
            <div data-aos="fade-left" data-aos-duration="800"
                class="col-lg-5 col-sm-10 shadow bg-light rounded m-3 px-5 py-3" id="urutan3">
                <div class="d-flex align-items-center justify-content-between mb-4">
    ...
    <section class="questioner ">
        <div class="row p-2 justify-content-center text-light g-0" id="content">
            <div class="col-12 text-center mt-5">
                <div class="title"><span data-aos="fade-up" data-aos-duration="1000" class="text-light h1" id="quest">Buku Tracer Study UINSU</span></div>
            </div>
            <div class="col-lg-6 col-sm-8 col-md-6 mx-2 ">
                <span data-aos="fade-up" data-aos-duration="1200">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt et distinctio quaerat ullam debitis atque deleniti eos voluptates architecto nisi.</span> 
            </div>
            <div class="col-lg-4 col-sm-8 col-md-6 mx-2" id="custom">
                <div class="input-group mb-3" data-aos="fade-up" data-aos-duration="1200">
                    <select class="form-select custom-select" id="inputGroupSelect04" aria-label="Example select with button addon">
    ...
    <section id="berita">
        <div class="row p-2 justify-content-center g-0">
            <div class="col-12 text-center  p-3 m-3">
                <div class="title" data-aos="fade-up" data-aos-duration="1000"><span>Berita Lowongan Pekerjaan</span></div>
            </div>
            <div class="row justify-content-center m-3">
                <div class="col-md-6 col-lg-5">
                    <div class="card mb-3" data-aos="fade-up" data-aos-duration="1200">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img  src="https://newuinsu.uinsu.ac.id/wp-content/uploads/2024/02/Graduation.jpg" class="img-fluid rounded-start" alt="..." style="object-fit: cover; height: 100%;">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 data-aos="fade-left" data-aos-duration="1200" class="card-title">Card title</h5>
                                    <p data-aos="fade-left" data-aos-duration="1000" class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                    <p data-aos="fade-up" data-aos-duration="1000" class="card-text"><small class="text-body-secondary">Last updated 3 mins ago</small></p>
                                </div>
                            </div>
                        </div>
                    </div>
