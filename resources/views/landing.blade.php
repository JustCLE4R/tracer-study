				  ...
				  <div class="row align-items-center">
					<div class="col-xl-6 col-lg-6">
					  <div class="about-content">
						<div class="section-title mb-30">
						  ...
						  <p class="wow fadeInUp" data-wow-delay=".3s">Kampus UINSU Menyediakan Sarana Bagi Alumni Untuk Berbagi Berita Lowongan Pekerjaan yang Selalu di Update Setiap Saat</p>
						</div>
						<ul>
					...
					<div class="col-xl-6 col-lg-6">
					  <div class="about-img text-lg-right wow fadeInUp" data-wow-delay=".5s">
						  <img src="https://cdni.iconscout.com/illustration/premium/thumb/job-application-2161927-1816233.png" alt="">
					  </div>
					</div>
				  </div>
				</div>
							...
							<div class="single-faq">
								...
								<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
									<div class="faq-content">
										...
										<a href="#0" class="button-sm radius-30 mt-2">Download <i class="lni lni-download"></i></a>
									</div>
									<div class="faq-content">
